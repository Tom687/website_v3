...
export default function ClickModal({ eventObject, onUpdate, onDelete, touch, setTouch }) {
  ...
  return (
    <ModalContent>
      ...
      <ModalText>
        Pour modifier la date du RDV, veuillez glisser / déposer le RDV ou modifier sa durée en maintenant le clic enfoncé sur le bord bas de l'évènement puis faire glisser la souris vers le haut ou le bas.
      </ModalText>
